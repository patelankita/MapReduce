...
JAR_NAME = a5FlightPrediction.jar

# AWS EMR Execution
aws.emr.release=emr-5.9.0
aws.region=us-east-2
aws.bucket.name=mr-a5-input
aws.jar.bucket=mr-a5-jar
aws.output=mr-a5-output
aws.subnet.id=subnet-1dcd8c66
aws.log.dir=mr-a5-logs
aws.num.nodes=4
aws.instance.type=m4.2xlarge

# Other Variables
cluster.name=A5ClusterNodes4
local.logs=logs
...
upload-app-aws:
	aws s3 cp $(jar.name) s3://${aws.jar.bucket}
